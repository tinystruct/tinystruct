...
```
  ...
  Para usar o framework como uma ferramenta de linha de comando independente, gere o JAR opcional que inclui todas as dependências (cerca de 50 MB, não faz parte do release):
```bash
